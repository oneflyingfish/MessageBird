...
namespace ShowNews
{
    public partial class ShowNewsOfMe : UserControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public ShowNewsOfMe(string news="",Bitmap userImage=null,string dateTime="",string userName="")
        {
            InitializeComponent();
        ...
        {
            //至多30秒显示一次时间
            if (!((DateTime.Now - ShowNewsOfMe.timebefore).TotalSeconds > 60.0 || ShowNewsOfMe.times == 0))
            {
                dateTime = "";
            }
            else
            {
                ShowNewsOfMe.timebefore = DateTime.Now;
            }
            ...
            if (userName != "")
            {
                ...
                nameLabel.AutoSize = true;  //防止昵称换行
